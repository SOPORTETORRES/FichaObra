<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OficinaTecnica.aspx.vb" Inherits="Maqueta.OficinaTecnica" %>
...
<%@ Register Src="~/WebParts/DetalleIT.ascx" TagPrefix="uc1" TagName="DetalleIT" %>
...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>P.A.G.O | Pestaña Oficina Tecnica</title>
    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-faded">
                <a class="navbar-brand" style="color: dimgray">Pestaña Oficina Tecnica</a>
            ...
            <form runat="server">
                <div class="row g-3 mb-3">
                            ...
                            <div class="card-body bg-light">
                                <div class="row g-3">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <asp:TextBox ID="txtEmpresa" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-3">
                                        <label class="form-label" for="lblNombreCliente">Ultimo EP presentado</label>
                                        <asp:TextBox ID="txtEP" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-3">
                                        <label class="form-label" for="lblDireccionObra">Tipo Obra</label>
                                        <asp:TextBox ID="txtTipoObra" CssClass="form-control" runat="server" Enabled="false" ></asp:TextBox>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" for="lblDireccionObra">Tipo Facturacion</label>
                                        <asp:TextBox ID="txtFacturacion" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="col-4">
                                        <label class="form-label" for="lblDireccionObra">Administrador de obra</label>
                                        <%--<asp:TextBox ID="txtCodigo" CssClass="form-control" runat="server"></asp:TextBox>--%>
                                        <asp:DropDownList ID="dpAdministradores" runat="server" class="form-select js-choice">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <%--<div class="col-2">
                                        <label class="form-label" for="lblDireccionObra">Codigo IT</label>
                                        <asp:TextBox ID="txtCodigoIT" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                    </div>--%>
                                    <div class="col-3">
                                    ...
                                    <div class="col-12">
                                        <asp:Panel ID="PanelOT" runat="server" Visible ="false">
                                            <asp:Button ID="btnGrabar" runat="server" Text="Grabar" class="btn btn-primary" />
                                            <asp:Button ID="btnExcel" runat="server" Text="Exportar a Excel" class="btn btn-primary" />
                                        </asp:Panel>
                                        <br />
                    ...
                    <br />
                    <%--Detalle IT--%>
                    <uc1:DetalleIT runat="server" ID="DetalleIT" />
                    <br />
                    <%--OBSERVACIONES--%>
