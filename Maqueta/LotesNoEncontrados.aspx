<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LotesNoEncontrados.aspx.vb" Inherits="Maqueta.LotesNoEncontrados" %>
                    ...
                    <div class="rounded-top-lg banner-titulo">
                        <div class="row flex-between-end2">
                            <div class="col-auto align-self-center">
                                <h5 class="mb-0" style="color: white">Listado de lotes no encontrados en todas las obras</h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                            <div>
                                ...
                                <div class="table-responsive scrollbar">
                                    <asp:GridView ID="gvLotes" runat="server" class="table table-striped table-bordered" BorderStyle="None">
                                        <Columns>
                                        </Columns>
                                    </asp:GridView>
                                </div>
